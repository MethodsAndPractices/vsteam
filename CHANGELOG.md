...
Merged [Pull Request](https://github.com/DarqueWarrior/vsteam/pull/338) from [Jhoneill](https://github.com/jhoneill) which included the following:

- Adds new functions Add/Set/Remove-VSTeamWorkItemTypes
