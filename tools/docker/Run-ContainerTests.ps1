...
if ($os -ne "Windows" -or $UseLinux) {
   Write-Warning "Platform is not Windows based but '$os'. Windows container do not work on linux based systems. Ignoring windows containers..."
}
