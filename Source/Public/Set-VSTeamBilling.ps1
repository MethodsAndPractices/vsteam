function Set-VSTeamBilling
{
   [CmdletBinding(SupportsShouldProcess = $true, ConfirmImpact = "High",
      HelpUri = 'https://methodsandpractices.github.io/vsteam-docs/docs/modules/vsteam/commands/Set-VSTeamBilling')]
   param(
   ...
   process
   {
      ...
      $billingToken = Get-VSTeamBillingToken
