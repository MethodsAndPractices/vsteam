...
function Update-VSTeamVariableGroup {
   ...
   process {
      ...
      $resp = _callAPI -Method Put -ProjectName $ProjectName -Area distributedTask -Resource VariableGroups -Version $([VSTeamVersions]::DistributedTask) -Body $Body -ContentType 'application/json' -Id $Id
