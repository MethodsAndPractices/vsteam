...
{
   public class ProcessTemplateCompleter : BaseCompleter
   {
      /// <summary>
      ...
      public ProcessTemplateCompleter() : base() { }
                                                                     ...
                                                                     IDictionary fakeBoundParameters)
      {
         ...
         SelectValues(wordToComplete, ProcessTemplateCache.GetCurrent(), values);
