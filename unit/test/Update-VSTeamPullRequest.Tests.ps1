    ...
    Describe 'Pull Requests' {
       ...
       Context 'Update-VSTeamPullRequest' {
            ...
            It 'Update-VSTeamPullRequest to Draft' {
                ...
                Update-VSTeamPullRequest -RepositoryId "45df2d67-e709-4557-a7f9-c6812b449277" -PullRequestId 19543 -ProjectName "Sandbox" -Draft -Force
            ...
            It 'Update-VSTeamPullRequest to Published' {
               ...
               Update-VSTeamPullRequest -RepositoryId "45df2d67-e709-4557-a7f9-c6812b449277" -PullRequestId 19543 -ProjectName "Sandbox" -Publish -Force
            ...
            It 'Update-VSTeamPullRequest to set status to abandoned' {
               ...
               Update-VSTeamPullRequest -RepositoryId "45df2d67-e709-4557-a7f9-c6812b449277" -PullRequestId 19543 -ProjectName "Sandbox" -Status abandoned -Force
            ...
            It 'Update-VSTeamPullRequest to set to enable auto complete' {
               ...
               Mock Invoke-RestMethod { return $result }
               Update-VSTeamPullRequest -RepositoryId "45df2d67-e709-4557-a7f9-c6812b449277" -PullRequestId 19543 -ProjectName "Sandbox" -EnableAutoComplete -AutoCompleteIdentity $user -Force
            ...
            It 'Update-VSTeamPullRequest to set to disable auto complete' {
               Mock Invoke-RestMethod { return $result }
               Update-VSTeamPullRequest -RepositoryId "45df2d67-e709-4557-a7f9-c6812b449277" -PullRequestId 19543 -ProjectName "Sandbox" -DisableAutoComplete -Force
