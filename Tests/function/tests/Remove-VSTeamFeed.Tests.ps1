...
Describe 'VSTeamFeed' {
   ...
   Context 'Remove-VSTeamFeed for organization ' {
      ...
      It 'should delete feed' {
         Remove-VSTeamFeed -id '00000000-0000-0000-0000-000000000000' -project 'testProject' -Force
   ...
   Context 'Remove-VSTeamFeed for project ' {
