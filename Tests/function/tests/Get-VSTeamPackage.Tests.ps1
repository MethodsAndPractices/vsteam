...
Describe 'VSTeamPackage' {
   ...
   Context 'Get-VSTeamPackage for organization' {
   ...
   Context 'Get-VSTeamPackage for project' {
      It 'should return all packages' {
         ## Act
         $actual = Get-VSTeamPackage -FeedId '00000000-0000-0000-0000-000000000001' -ProjectName 'testProject' -protocolType NuGet
      ...
      It 'should return package by id' {
         ## Act
         $actual = Get-VSTeamPackage -FeedId '00000000-0000-0000-0000-000000000001' -ProjectName 'testProject' `
            -PackageId 'b8b066d8-b272-0000-adf2-e4557f67cd98' -includeAllVersions
      ...
      It 'should return all packages from pipeline by name' {
         ...
         ## Act
         $actual = $($feed | Get-VSTeamPackage -hideUrls -ProjectName 'testProject')
      ...
      It 'should return all packages from pipeline by value' {
         ## Act
         $actual = $('00000000-0000-0000-0000-000000000001' | Get-VSTeamPackage -ProjectName 'testProject')
